...
function displayProjectList() {
  ...
  for (let i = 0; i < _toDoFunctions__WEBPACK_IMPORTED_MODULE_0__.todoList.length; i++) {
    ...
    function handleDeleteProjectButton() {
      ...
      (0,_toDoFunctions__WEBPACK_IMPORTED_MODULE_0__.deleteProject)(projectToDelete);
    ...
    function hanleEditProjectButton() {
      ...
      newProjectTitleInput.value = _toDoFunctions__WEBPACK_IMPORTED_MODULE_0__.todoList[i].title;
      ...
      newProjectTitleForm.addEventListener("submit", (event) => {
        event.preventDefault();
        (0,_toDoFunctions__WEBPACK_IMPORTED_MODULE_0__.renameProject)(projectToEdit, newProjectTitleInput.value);
        updateProjectList();
        updateTaskList();
      });
    }
    ...
    function displayTaskList(projectListIndex) {
      const project = _toDoFunctions__WEBPACK_IMPORTED_MODULE_0__.todoList[projectListIndex];
      ...
      for (let j = 0; j < projectTasksList.length; j++) {
        ...
        function handleChangeStatusButton() {
          ...
          (0,_toDoFunctions__WEBPACK_IMPORTED_MODULE_0__.changeTaskStatus)(projectToEdit, taskToEdit);
        ...
        function handleDeleteTaskButton() {
          ...
          (0,_toDoFunctions__WEBPACK_IMPORTED_MODULE_0__.deleteTask)(projectToModify.dataset.index, parseInt(taskToDelete));
          updateTaskList();
        }
