...
function createProjectItem() {
  ...
  projectDivs.forEach((projectDiv) => {
    const project = _toDoFunctions__WEBPACK_IMPORTED_MODULE_0__.todoList[projectDiv.dataset.index];
...
function hanleEditProjectButton(project) {
  ...
  cancelProjectEditButton.addEventListener("click", (event) => {
    ...
    projectTitleDiv.textContent = _toDoFunctions__WEBPACK_IMPORTED_MODULE_0__.todoList[i].title;
  });

  newProjectTitleForm.addEventListener("submit", (event) => {
    event.preventDefault();
    (0,_toDoFunctions__WEBPACK_IMPORTED_MODULE_0__.renameProject)(activeProject, newProjectTitleInput.value);
    updateProjectList();
    updateTaskList();
  });
}
...
function handleDeleteProjectButton() {
  (0,_toDoFunctions__WEBPACK_IMPORTED_MODULE_0__.deleteProject)(activeProject);
...
function handleChangeStatusButton() {
  (0,_toDoFunctions__WEBPACK_IMPORTED_MODULE_0__.changeTaskStatus)(activeProject, activeTask);
...
function handleDeleteTaskButton() {
  (0,_toDoFunctions__WEBPACK_IMPORTED_MODULE_0__.deleteTask)(_toDoFunctions__WEBPACK_IMPORTED_MODULE_0__.todoList[activeProject], parseInt(activeTask));
  updateTaskList();
}
